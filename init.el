(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (dimish undo-tree arjen-grey-theme smart-mode-line-powerline-theme flycheck all-the-icons projectile f company haskell-mode smart-mode-line sml git-gutter gitgutter magit base16-theme peacock-theme use-package))))
(custom-set-faces
